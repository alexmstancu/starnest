...
**63 findings: 57 closed, 6 open, and every one of the six is open by decision rather than by
neglect**: P35 and P36 on run bookkeeping, P28's deferred spend ledger, P38's mitigated LLM
editions, P6's Cloudflare block, P10's unstored exchange rates, and P39's postponed geography.
P4 is recorded as out of scope rather than open. **P63 was found by fixing one of the review's own low
