...
| `docs/openapi.yaml` | **Written.** The REST contract — 40 operations, **all of them served** since 2026-09-12. It stays the target rather than a record of the code: it is written first, and `docs/openapi.implemented.yaml` is generated from the routes. The **target**, hand-written and deliberately ahead of the code. `docs/openapi.implemented.yaml` is the generated **truth**; see "Two contracts" below |
